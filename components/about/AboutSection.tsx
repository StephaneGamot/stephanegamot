...
export default function AboutSection() {
    return (
        <section id="about" className="relative section">
            ...
            <div
                className="mx-auto max-w-6xl px-8 lg:px-12"
            ...
            >
                <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-12 lg:gap-24">
                    ...
                    <ScrollReveal className="lg:col-span-5" y={40}>
                        <ParallaxImage
                            src={Portrait}
                            alt="Portrait de Stéphane Gamot, développeur web freelance et consultant SEO en Belgique"
                            offset={30}
                            className="mx-auto"
                            style={{
                                width: "100%",
                    ...
                    >
                        ...
                        <StaggerItem>
                            ...
                            >
                                Ingénieur en développement full-stack et{" "}
                                <Link
                                    href="/services/seo"
                                ...
                                basé en Belgique. Je crée des sites{" "}
                                <Link
                                ...
                                {" "}rapides, élégants et optimisés pour le référencement
                                naturel et la conversion. Mon approche combine rigueur
                                technique, design éditorial et stratégie de contenu pour
                                des sites qui performent autant sur Google que dans la tête
                                de vos visiteurs.
                            </p>
                        </StaggerItem>
