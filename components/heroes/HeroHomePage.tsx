                ...
                <div className="mx-auto max-w-7xl px-6 py-10 sm:py-12 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-12">
                    ...
                    <div className="mt-16 sm:mt-24 lg:mt-0 lg:shrink-0 lg:grow">
                        ...
                        <div className="relative mx-auto w-[22.875rem] max-w-full drop-shadow-xl aspect-[366/729]">
                            {/* Écran (image) — dimensions/position en % du viewBox */}
                            <div
                            ...
                            >
                                <Image
                                    ...
                                    className="object-cover" /* retire temporairement l’animation si besoin */
                                    priority={false}
                                />
                            </div>

                            {/* Châssis du téléphone au-dessus */}
                            <svg role="img" viewBox="0 0 366 729" className="absolute inset-0 z-10 h-full w-full">
