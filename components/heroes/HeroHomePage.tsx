            ...
            <div className="relative isolate pt-1">
                <div className="mx-auto max-w-7xl px-6 py-10 sm:py-12 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-12">
                    ...
                    <div className="mt-16 sm:mt-24 lg:mt-0 lg:shrink-0 lg:grow">
                        {/* Conteneur proportionnel au mock (366 × 729) */}
                        <div className="relative mx-auto w-[22.875rem] max-w-full drop-shadow-xl aspect-[366/729]">
                            {/* Châssis du téléphone — en dessous */}
                            <svg role="img" viewBox="0 0 366 729" className="absolute inset-0 h-full w-full z-0">
                            ...
                            {/* Écran (image) — AU-DESSUS, position en % pour scaler partout */}
                            <div
                                className="absolute z-10 overflow-hidden rounded-[36px] animate-float-y-slow"
                                style={{
                                    left: "6.56%",   // 24 / 366
                                    top: "3.29%",    // 24 / 729
                                    width: "86.34%", // 316 / 366
                                    height: "93.84%" // 684 / 729
                                }}
                            >
                                {/* fin liseré pour simuler la bordure interne (optionnel mais joli) */}
                                <div className="pointer-events-none absolute inset-0 rounded-[36px] ring-1 ring-black/30" />
                                <Image
                                    src={Test}
                                    alt="Aperçu d’un site conçu par Stéphane Gamot"
                                    fill
                                    sizes="(max-width: 640px) 90vw, 366px"
