            ...
            <div className="relative isolate pt-1">
                <div className="mx-auto max-w-7xl px-6 py-10 sm:py-12 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-12">
                    ...
                    <div className="mt-16 sm:mt-24 lg:mt-0 lg:shrink-0 lg:grow">
                        <div className="relative mx-auto w-[22.875rem] max-w-full drop-shadow-xl">
                            {/* Écran (image) – positionné exactement à l’intérieur du châssis */}
                            <div
                                className="absolute left-[24px] top-[24px] h-[684px] w-[316px] overflow-hidden rounded-[36px]"
                                aria-hidden="true"
                            >
                                <Image
                                    src={Test}
                            ...
                            {/* Châssis du téléphone en SVG (au-dessus) */}
                            <svg role="img" viewBox="0 0 366 729" className="relative z-10 w-full">
